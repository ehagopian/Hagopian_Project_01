...
This project uses data from the CDC and includes two variables: distance from lead smelter to the subject's home (near = $\leq$ 1 mile, far = > 1 mile) and IQ score. **Figure 1** depicts the distributions of IQ scores for those living near and those living far from the smelter, though it is difficult to see the distributions because of one individual with a much higher IQ than the others. I am pretending to not notice this for the first commit.
